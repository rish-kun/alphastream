...
class StockService:
    ...
    async def get_stock_alpha(self, ticker: str) -> dict:
        ...
        # ⚡ Bolt Optimization: Push deduplication to the database level using PostgreSQL's DISTINCT ON
        # Impact: Eliminates fetching all historical metrics into memory and Python-level looping.
        # This dramatically reduces memory footprint and network transfer, making the endpoint much faster.
        metrics_stmt = (
            select(AlphaMetric)
