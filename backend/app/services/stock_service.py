...
class StockService:
    ...
    async def get_stock_alpha(self, ticker: str) -> dict:
        ...
        # ⚡ Bolt Optimization: Using PostgreSQL's DISTINCT ON to deduplicate at the database level,
        # preventing N rows from being transferred and instantiated in Python memory.
        metrics_stmt = (
            select(AlphaMetric)
