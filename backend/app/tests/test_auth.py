...
from app.schemas.user import TokenResponse as Token, UserResponse
        ...
        with patch("app.api.v1.auth.AuthService") as MockService:
            ...
            instance.create_tokens = AsyncMock(
                return_value=Token(
                    ...
                    token_type="bearer",
                    user=UserResponse(id=TEST_USER_ID, email=TEST_USER_EMAIL, full_name=TEST_USER_NAME, is_active=True, created_at=datetime.now(UTC)),
                )
            )
